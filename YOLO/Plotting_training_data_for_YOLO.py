...
CSV_FILE = "/home/andreas/AWAS/AWAS-Project/YOLO/runs/YOLO11_modelType_M_1280x960/results.csv"  # Path to your YOLO training CSV file.
OUTPUT_DIR = "plots"                         # Base folder for saving all plots.
RUN_FOLDER_NAME = "YOLO11M_1280"                   # Manually set run-specific folder name; change per run.
