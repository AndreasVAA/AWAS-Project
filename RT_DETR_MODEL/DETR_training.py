...
def train_model(weight_decay = 0.0005, lr0 = 0.01, rect=False , model_path ="rtdetr-l.pt", project= "DUMDUMTESTING", optimizer = "auto", config_path="/home/itk/Desktop/Andreas/AWAS-Project/YOLO/dataConf.yaml", imgsz=640, batch=16, epochs=500, name="Dum_DUm_testing", freeze=None):    
    """
